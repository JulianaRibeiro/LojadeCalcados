...
public class ConsultaFornecedor extends JDialog implements
	...
	public ConsultaFornecedor() {
		...
		this.dados = Fornecedor.lista;

		for (Fornecedor c : this.dados) {

			dtf.addRow(new Object[] { c.cod, c.nome, c.tel, c.email });
		}
	...
	public void mouseClicked(MouseEvent e) {
		if (e.getClickCount() == 2) {
			...
			Fornecedor c = this.dados.get(row);

			CadastroFornecedor tela = new CadastroFornecedor(c);
